...
| :--- | :---: | :--- |
| **Exergía Promedio (Useful Signal)** | **97.81%** | Transmisión efectiva de datos / pureza existencial. |
| **Índice de Humo Promedio (Entropic Noise)** | **2.19%** | Energía perdida en copywriting comercial o clickbait. |
| **Densidad C5-REAL Promedio** | **0.16%** | Presencia de anclajes inmutables o pruebas de realidad. |
| **Densidad Técnica Promedio** | **4.89%** | Código, APIs, algoritmos e ingeniería de datos. |
| **Anclajes Clickbait Promedio** | **3.08%** | Ruido de enganche cognitivo / clickbaiting. |
| **Llamadas Comerciales Promedio** | **1.85%** | Esfuerzo relativo de venta / monetización directa. |
...
| :---: | :--- | :---: | :---: | :---: | :---: | :--- |
| 1 | [sensitivitymanagement](https://sensitivitymanagement.substack.com) | **55.0%** | 45.0% | 100.0% | `en` | `Hype-driven / Divulgativo` |
| 2 | [norrisearch](https://norrisearch.substack.com) | **55.0%** | 45.0% | 0.0% | `en` | `Comercial / Transaccional` |
| 3 | [invierteconseb](https://invierteconseb.substack.com) | **55.0%** | 45.0% | 80.0% | `es` | `Hype-driven / Divulgativo` |
| 4 | [michaelwigginsdeoliveira](https://michaelwigginsdeoliveira.substack.com) | **64.0%** | 36.0% | 20.0% | `en` | `Comercial / Transaccional` |
| 5 | [aimafia](https://aimafia.substack.com) | **66.0%** | 34.0% | 80.0% | `es` | `Técnico / Práctico` |
| 6 | [optionsoracle](https://optionsoracle.substack.com) | **73.0%** | 27.0% | 0.0% | `en` | `Comercial / Transaccional` |
| 7 | [ryanstax](https://ryanstax.substack.com) | **73.0%** | 27.0% | 40.0% | `en` | `Hype-driven / Divulgativo` |
| 8 | [nosolosuerte](https://nosolosuerte.substack.com) | **73.0%** | 27.0% | 40.0% | `es` | `Hype-driven / Divulgativo` |
| 9 | [jwho](https://www.2ndorderthinkers.com) | **75.0%** | 25.0% | 40.0% | `en` | `Técnico / Práctico` |
| 10 | [qnickmans](https://qnickmans.substack.com) | **77.5%** | 22.5% | 50.0% | `en` | `Hype-driven / Divulgativo` |
| 11 | [moneystuff](https://moneystuff.substack.com) | **77.5%** | 22.5% | 0.0% | `en` | `Comercial / Transaccional` |
| 12 | [hablemosdefondos](https://hablemosdefondos.substack.com) | **77.5%** | 22.5% | 0.0% | `es` | `Comercial / Transaccional` |
| 13 | [karensmiley](https://karensmiley.substack.com) | **82.0%** | 18.0% | 40.0% | `en` | `Hype-driven / Divulgativo` |
| 14 | [christinentim](https://christinentim.substack.com) | **82.0%** | 18.0% | 40.0% | `en` | `Hype-driven / Divulgativo` |
| 15 | [roguequant](https://roguequant.substack.com) | **82.0%** | 18.0% | 0.0% | `en` | `Comercial / Transaccional` |
| 16 | [threeeyedscholar](https://threeeyedscholar.substack.com) | **82.0%** | 18.0% | 0.0% | `en` | `Comercial / Transaccional` |
...
| 40 | [post](https://post.substack.com) | **82.0%** | 18.0% | 40.0% | `en` | `Hype-driven / Divulgativo` |
| 41 | [inviertejoven](https://inviertejoven.substack.com) | **82.0%** | 18.0% | 40.0% | `es` | `Hype-driven / Divulgativo` |
| 42 | [macariva](https://macariva.substack.com) | **82.0%** | 18.0% | 20.0% | `es` | `Hype-driven / Divulgativo` |
