...
<div class="manifesto-box" style="background: rgba(43, 59, 229, 0.05); border-left: 3px solid var(--color-yinmn, #2B3BE5); padding: 1.5rem; margin: 2.5rem 0; border-radius: 0 8px 8px 0;">
  <p style="font-style: italic; font-weight: 500; margin-bottom: 0;">
    Estamos rodeados de comunicadores obsesionados con hackear algoritmos y automatizar su enganche para alimentar un ego de cartón piedra. Han convertido la comunicación en una coreografía vacía donde el creador actúa y la masa consume en un estado de letargo absoluto.
  </p>
  <p style="font-style: italic; font-weight: 500; margin-top: 1rem; margin-bottom: 0;">
    Nosotros elegimos situarnos en la trinchera opuesta para defender la inteligencia relacional. Preferimos una manada pequeña y compacta que ruge con fuerza antes que una masa gigante de sujetos anestesiados que consumen lo que un software decide.
  </p>
  <p style="font-style: italic; font-weight: 500; margin-top: 1rem; margin-bottom: 0;">
    Tu voz tiene valor cuando genera espacios de reflexión real y activa el vigor de los tuyos. Recupera tu soberanía frente a las pantallas y empieza a medir tu impacto por la fuerza del vínculo y no por las plantillas estandarizadas de un negocio digital sin alma. 🔄🦁
  </p>
</div>
