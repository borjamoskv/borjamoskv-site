...
class BiologicalLedger:
    ...
    def append_block(
        self, metrics: Dict[str, float], subject_type: str
    ) -> Dict[str, Any]:
...
if __name__ == "__main__":
    ...
    domestic = ledger.append_block(
        {"AFI": 0.10, "ESR": 0.20, "MVO": 0.15, "MII": 0.10, "SADE": 0.30, "AMB": 0.10},
        "Domestic-Subject",
    )

    # Simulation of Sovereign-Subject
    sovereign = ledger.append_block(
        {"AFI": 0.95, "ESR": 0.90, "MVO": 0.98, "MII": 0.95, "SADE": 0.85, "AMB": 0.92},
        "Sovereign-Subject",
    )
    ...
    tacuinum = ledger.append_block(
        {"AFI": 0.88, "ESR": 0.95, "MVO": 0.90, "MII": 0.98, "SADE": 0.99, "AMB": 0.95},
        "Tacuinum-Subject",
    )
